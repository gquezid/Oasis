<%-- 
    Document   : pagEventoGrupo
    Created on : 29/01/2013, 19:44:27
    Author     : Gabriel Quézid
--%>

<jsp:include page="../form/pagCadastroGrupo.jsp" /> 
                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav">
                            ...
                            <li class="">
                                <a href="./pagEventoUsuario.jsp">Visualize seu perfil</a>
                            </li>
                            <li class="">
...
================================================== -->
        <header class="jumbotron subhead" id="overview">
            <div class="container">
                ...
                <p class="lead">Criando um grupo, você pode gerenciar suas próprias peladas. Experimente!</p>
            </div>
        </header>
        ...
        <div class="container">
            ...
            <div align="center">
                <a href="#myModal" role="button" class="btn btn-large" data-toggle="modal">Cadastrar Grupo</a>
            </div>
        </div>
